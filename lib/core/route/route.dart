...
import 'package:Ouiacsh_app/view/components/bottom-nav-bar/bottom_nav_bar.dart';
import 'package:Ouiacsh_app/view/screens/Profile/profile_screen.dart';
import 'package:Ouiacsh_app/view/screens/account/change-password/change_password_screen.dart';
import 'package:Ouiacsh_app/view/screens/add-money/add_money/add_money_screen.dart';
import 'package:Ouiacsh_app/view/screens/add-money/add_money/add_money_web_view.dart';
import 'package:Ouiacsh_app/view/screens/add-money/add_money_history/add_money_history_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/email_verification_page/email_verification_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/forget_password/forget_password/forget_password.dart';
import 'package:Ouiacsh_app/view/screens/auth/forget_password/reset_password/reset_password_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/forget_password/verify_forget_password/verify_forget_password_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/kyc/kyc.dart';
import 'package:Ouiacsh_app/view/screens/auth/login/login_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/profile_complete/profile_complete_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/registration/registration_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/sms_verification_page/sms_verification_screen.dart';
import 'package:Ouiacsh_app/view/screens/auth/two_factor_screen/two_factor_verification_screen.dart';
import 'package:Ouiacsh_app/view/screens/edit_profile/edit_profile_screen.dart';
import 'package:Ouiacsh_app/view/screens/exchange/exchange_money_screen.dart';
import 'package:Ouiacsh_app/view/screens/invoice/create_invoice/create_invoice_screen.dart';
import 'package:Ouiacsh_app/view/screens/invoice/my_invoice/invoice_screen.dart';
import 'package:Ouiacsh_app/view/screens/invoice/update_invoice/update_invoice_screen.dart';
import 'package:Ouiacsh_app/view/screens/money_discharge/make_payment/make_payment.dart';
import 'package:Ouiacsh_app/view/screens/otp/otp_screen.dart';
import 'package:Ouiacsh_app/view/screens/money_discharge/money_out/money_out_screen.dart';
import 'package:Ouiacsh_app/view/screens/privacy_policy/privacy_policy_screen.dart';
import 'package:Ouiacsh_app/view/screens/qr_code/my_qr_code.dart';
import 'package:Ouiacsh_app/view/screens/qr_code/qr_code_scanner.dart';
import 'package:Ouiacsh_app/view/screens/request-money/request_money/request_money.dart';
import 'package:Ouiacsh_app/view/screens/request-money/request_to_me/request_to_me_screen.dart';
import 'package:Ouiacsh_app/view/screens/splash/splash_screen.dart';
import 'package:Ouiacsh_app/view/screens/transaction/transaction_history_screen.dart';
import 'package:Ouiacsh_app/view/screens/transfer/transfer_money_screen.dart';
import 'package:Ouiacsh_app/view/screens/voucher/create_voucher/create_voucher.dart';
import 'package:Ouiacsh_app/view/screens/voucher/my_voucher/my_voucher_screen.dart';
import 'package:Ouiacsh_app/view/screens/voucher/redeem_log/redeem_log_screen.dart';
import 'package:Ouiacsh_app/view/screens/wallet/my_wallet_screen.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_history/withdraw_history_screen.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_method/add_withdraw_method.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_method/edit_withdraw_method.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_method/withdraw_method_screen.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_money/withdraw_money_screen.dart';
import 'package:Ouiacsh_app/view/screens/withdrawals/withdraw_preview/withdraw_preview_screen.dart';
